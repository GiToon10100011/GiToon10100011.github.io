...
또한, 주키 역시 엔티티이므로 개별적으로 생각하면 안된다. 
...
ORM(Object Relational Mapping) - MongoDB의 Mongoose, TS/JS에서의 Prisma 등.. 데이터베이스와 객체지향 프로그래밍 언어 사이의 데이터를 변환해주는 기술이다. ORM을 통해 SQL 쿼리를 직접 작성하지 않고 프로그래밍 언어의 객체를 통해 데이터베이스를 조작할 수 있다. 
